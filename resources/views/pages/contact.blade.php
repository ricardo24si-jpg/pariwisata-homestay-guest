        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3">
                    ...
                    <h4 class="lh-base mb-4">Receive messages instantly with our PHP and Ajax contact form - available in
                        the <a class="text-secondary" href="https://htmlcodex.com/downloading/?item=3376">Pro Version</a>
                        only.</h4>
                    <form>
                        <div class="row g-4">
