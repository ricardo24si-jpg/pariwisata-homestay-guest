...
@section('content')
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Homestay</h1>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="homestay-card">
                                ...
                                <div class="homestay-img">
                                    <img src="{{ asset('Assets/img/office-3.jpg') }}">
    ...
    <style>
        ...
        .homestay-card:hover .homestay-img img {
