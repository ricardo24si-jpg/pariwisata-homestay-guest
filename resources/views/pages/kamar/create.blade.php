...
@section('content')
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Tambah Kamar</h1>
                <ol class="breadcrumb justify-content-center text-white mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html" class="text-white">Home</a></li>
                    <li class="breadcrumb-item"><a href="#" class="text-white">Pages</a></li>
                    <li class="breadcrumb-item active text-secondary">Tambah kamar</li>
                </ol>
        </div>
    </div>
    <!-- Header End -->
        ...
        <div class="container">
            <div class="booking p-5 rounded-4 shadow-lg"
                ...
                <div class="text-center mb-4">
                    <h2 class="fw-bold text-gradient mb-3">Kamar Homestay</h2>
