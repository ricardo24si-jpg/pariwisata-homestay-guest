...
<div class="container py-5">
    ...
    <div class="section-title text-center mb-5">
        ...
        <h1 class="display-5 mb-4">Tambah Ulasan</h1>
    </div>
    ...
    <form action="{{ route('ulasan.store') }}" method="POST" class="card shadow-sm p-4">
        @csrf
        ...
        <div class="row g-3">
                ...
                <select name="destinasi_id" class="form-control">
                    ...
                    @foreach ($destinasi as $d)
                        <option value="{{ $d->destinasi_id }}"
                            {{ old('destinasi_id') == $d->destinasi_id ? 'selected' : '' }}>
                            {{ $d->nama }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-12">
                ...
                <textarea name="komentar" rows="3"
                    class="form-control">{{ old('komentar') }}</textarea>
            </div>
